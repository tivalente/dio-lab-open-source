...
### 9) Aguarde a Revisão
Após criar o Pull Request, aguarde a revisão dos mantenedores do projeto. Eles poderão solicitar ajustes ou melhorias antes de aprovar sua contribuição

### 10) Imtegre o Feedback
Caso receba feedback, faça as alterações necessárias e atualize seu PullRequest. Isso pode envolver novos commits na mesma branch.

### 11) Celebre suas Contribuições
Após a aprovação e o merge do seu Pull Request, celebre sua contribuição para a comunidade open source!
Compartilhe sua eperiência e incentive outros a contribuirem também.
